	...
	return (
      <div className=" w-full relative">
        <input type="text" placeholder="Search Movie..."
          className="p-3 w-[420px] sm:w-[500px] md:w-[760px] focus:outline-none tracking-wider rounded-xl bg-gray-900 text-gray-300 w-full shadow-sm shadow-indigo-900/50"
